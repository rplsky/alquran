...
class Quran{
    ...
    public $password = "";
    public $databaseName = "db_alquran";
    ...
    public function getAyat($surat = null, $translationKey = null, $ayatFrom = null, $ayatTo = null)
    {
        ...
        if($translationKey != null)
        {
            ...
            ".$this->tableAyat.".ayat_number, ".$this->tableTranslation.".translation, ".$this->tableTranslation.".latin
            from ".$this->tableAyat." 
    ...
    public function getJuz($juz, $translationKey = null)
    {
        ...
        ".$this->tableAyat.".surat, ".$this->tableAyat.".ayat, ".$this->tableAyat.".ayat_key,
        ".$this->tableAyat.".ayat_number, 
        ".$this->tableTranslation.".translation, ".$this->tableTranslation.".latin
        from ".$this->tableAyat." 
        left join(".$this->tableTranslation.") 
        on(".$this->tableTranslation.".ayat_key = ".$this->tableAyat.".ayat_key and ".$this->tableTranslation.".translation_key = '".$translationKey."')
        where (1 = 1) $filter 
    ...
    {
        $arr = explode(":", $ayatKey);
        return $this->suratName[(int) $arr[0]][0]. ' ( '.$this->suratName[(int) $arr[0]][1].' ) : '.((int) $arr[1]);
    }
    ...
    public function buildMenu()
    {
        ...
        {
            $menu .= '<li><a href="./?s='.$number.'"><i class="fa fa-circle-o"></i> '.$number.'. '.htmlspecialchars($names[0]).' ( '.htmlspecialchars($names[1]).' ) </a></li>';
        }
        return $menu;
    }
    public function buildJuz()
    {
        ...
        {
            $menu .= '<li><a href="./?j='.$number.'"><i class="fa fa-circle-o"></i> Juz '.$number.'</a></li>';
        }
        return $menu;
    }
}
