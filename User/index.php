  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="Alquran/index.php">
            <i class="fa fa-folder-open"></i> <span>Data Al Quran</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        <li>
          <a href="Hadits/index.php?page=hadits&aksi=aktif">
            <i class="fa fa-archive"></i> <span>Data Hadits</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
